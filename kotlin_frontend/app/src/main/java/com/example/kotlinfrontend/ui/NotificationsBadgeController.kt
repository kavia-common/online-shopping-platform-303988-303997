...
/**
 * Controls the notifications badge action view in a Toolbar menu item.
 */
class NotificationsBadgeController(
    ...
    private val badgeText: TextView = actionView.findViewById(R.id.notificationsBadge)
    ...
    private fun Toolbar.inflateActionView(): View {
        ...
        return inflater.inflate(R.layout.view_notifications_badge_action, this, false)
    }
}
